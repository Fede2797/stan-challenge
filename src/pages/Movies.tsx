...
export const Movies = ({ isLoading, setSection, contentToDisplay }: MoviesProps) => {

  useEffect(() => {
    setSection( sections.MOVIES );
  }, [])
...

        {
          isLoading 
            ? (<Loading />)
              : (
                <>
                  <h1 className="px-4 pt-14 pb-8 text-4xl drop-shadow-[0px_0px_10px_#000] text-center">Movies</h1>
                  <div className="">
                  </div>
                </>
              )
